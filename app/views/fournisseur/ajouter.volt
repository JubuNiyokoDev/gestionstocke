...
{% block content %}
<form action="{{ url('fournisseur/create') }}" method="post">
    <h2>Ajouter un Fournisseur</h2>
    <div>
        <label for="nom_complet_fournisseur">Nom complet :</label>
        <input type="text" id="nom_complet_fournisseur" name="nom_complet_fournisseur" required>
    </div>
    <div>
    ...
    <div>
        ...
        <input type="text" id="telephone_fournisseur" name="telephone_fournisseur" required>
    </div>
    <div>

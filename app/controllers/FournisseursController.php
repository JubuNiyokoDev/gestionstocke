...
class FournisseursController extends ControllerBase
{
    ...
    public function createAction()
    {
        ...
        $fournisseur->TELEPHONEFOURNISSEUR = $this->request->getPost("TELEPHONE_FOURNISSEUR");
    ...
    public function saveAction()
    {
        ...
        $fournisseur->nOMCOMPLETFOURNISSEUR = $this->request->getPost("NOM_COMPLET_FOURNISSEUR");
        $fournisseur->aDRESSEFOURNISSEUR = $this->request->getPost("ADRESSE_FOURNISSEUR");
        $fournisseur->eMAILFOURNISSEUR = $this->request->getPost("EMAIL_FOURNISSEUR");
        $fournisseur->tELEPHONEFOURNISSEUR = $this->request->getPost("TELEPHONE_FOURNISSEUR");
